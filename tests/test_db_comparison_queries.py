...
def test_query(name, query_func, *args):
...
for metric in metrics:
    ...
    if test_query(name, get_db_comparison_team_top, metric):
        passed += 1
    else:
        failed += 1
...
for metric in metrics:
    ...
    if test_query(name, get_db_comparison_grade_top, metric):
        passed += 1
    else:
        failed += 1
...
for metric in metrics:
    ...
    if test_query(name, get_db_comparison_class_top, metric):
        passed += 1
    else:
        failed += 1
